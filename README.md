...
Built in Clojure(Script) with the help of [Reagent](https://github.com/reagent-project), [Re-frame](https://github.com/Day8/re-frame), [Garden](https://github.com/noprompt/garden), [Figwheel](https://figwheel.org), [Gentium Basic](https://fonts.google.com/specimen/Gentium+Basic), and [conic-gradient](https://github.com/leaverou/conic-gradient).
